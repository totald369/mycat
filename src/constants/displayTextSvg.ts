...
export const DISPLAY_TITLE = {
  ...
  homeLine1Left: svg("text-title-1", 63, 40),
  homeLine1Right: svg("text-title-2", 63, 40),
  homeLine2: svg("text-title-3", 237, 80),
  step1: svg("text-title-4", 200, 32),
  step2: svg("text-title-5", 200, 32),
  step3: svg("text-title-6", 200, 32),
  step3Calculating: svg("text-title-7", 249, 92),
  resultComplete: svg("text-title-8", 150, 40),
  resultBalanced: svg("text-title-9", 257, 40),
  resultHigh: svg("text-title-11", 187, 40),
  resultLow: svg("text-title-10", 208, 40),
} as const;

export const DISPLAY_BUTTON = {
  start: svg("text-button-1", 81, 32),
  step1Next: svg("text-button-2", 54, 32),
  step2Prev: svg("text-button-3", 54, 32),
  step2Next: svg("text-button-4", 54, 32),
  step3Prev: svg("text-button-3", 54, 32),
  step3Next: svg("text-button-4", 54, 32),
  prev: svg("text-button-2", 54, 32),
  next: svg("text-button-3", 54, 32),
  result: svg("text-button-5", 86, 32),
  retry: svg("text-button-5", 86, 32),
  share: svg("text-button-6", 86, 32),
} as const;
