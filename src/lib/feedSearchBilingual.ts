...
const SEARCH_ALIAS_GROUPS: readonly (readonly string[])[] = [
  ...
  ["브릿", "brit", "brit care"],
  ["플래티넘", "platinum"],
  ["정글키친", "jungle kitchen", "junglekitchen"],
  ["프로뉴트리션", "pro nutrition", "pro-nutrition", "flatazor"],
  ["프레스티지", "prestige"],
  ["퓨어라이프", "pure life", "purelife"],
  ["게더", "gather"],
  ["쉬바", "sheba"],
  ...
  ["중성화", "sterilised", "neutered", "spayed"],
  ["미트크리스프", "meatcrisp", "meat crisp"],
  ["치킨포켓", "chicken pocket"],
  ["래빗포켓", "rabbit pocket"],
  ["램포켓", "lamb pocket"],
  ["더블민스", "double minced"],
