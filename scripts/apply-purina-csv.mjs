/**
 * purina-scraped.json → prisma/cat_food.csv 퓨리나 레거시 보강
 * Usage: node scripts/apply-purina-csv.mjs
 */
...
const scraped = JSON.parse(
  readFileSync(join(process.cwd(), "scripts", "purina-scraped.json"), "utf8"),
);
...
console.log(`Updated ${updated} Purina legacy rows in ${CSV_PATH}`);
