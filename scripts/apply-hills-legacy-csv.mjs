/**
 * hills-legacy-scraped.json → prisma/cat_food.csv 힐스 레거시 보강
 * Usage: node scripts/apply-hills-legacy-csv.mjs
 */
...
const scraped = JSON.parse(
  readFileSync(join(process.cwd(), "scripts", "hills-legacy-scraped.json"), "utf8"),
);
...
console.log(`Updated ${updated} Hills legacy rows in ${CSV_PATH}`);
