/**
 * coupang-scraped.json → prisma/cat_food.csv 쿠팡 SKU append
 * Usage: node scripts/apply-coupang-csv.mjs
 */
...
const data = JSON.parse(
  readFileSync(join(process.cwd(), "scripts", "coupang-scraped.json"), "utf8"),
);
