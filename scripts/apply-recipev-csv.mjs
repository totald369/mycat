/**
 * recipev-scraped.json → prisma/cat_food.csv 유한양행 레시피브이 보강
 * Usage: node scripts/apply-recipev-csv.mjs
 */
...
const scraped = JSON.parse(
  readFileSync(join(process.cwd(), "scripts", "recipev-scraped.json"), "utf8"),
);
...
console.log(`Updated ${updated} Recipe V rows in ${CSV_PATH}`);
